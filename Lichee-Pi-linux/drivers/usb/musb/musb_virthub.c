...
void musb_port_reset(struct musb *musb, bool do_reset)
{
	...
	if (do_reset) {
		...
		printk("CALLED MUSB_PORT_RESET ---- root port reset stopped\n");
		...
		if (power & MUSB_POWER_HSMODE) { // commenting this out just breaks it...
			musb_dbg(musb, "high-speed device connected");
			printk("CALLED MUSB_PORT_RESET ---- high-speed device connected\n");
